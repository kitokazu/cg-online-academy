...
export default function Class0() {
  return (
    <PageLayout>
      {/* Page Header */}
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <nav className="flex items-center justify-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <span className="text-foreground">クラス 0</span>
            </nav>

            <p className="text-primary text-sm tracking-[0.2em] uppercase mb-4">Class 0 — Part 1</p>
            <h1 className="text-3xl md:text-5xl font-bold mb-6">
              <span className="text-gradient-gold">Maya</span> 基本操作 1
            </h1>
            <div className="section-divider mb-6" />
            <p className="text-muted-foreground text-lg leading-relaxed">
              Mayaの基本的なインターフェース操作からオブジェクトの変形、コンポーネント編集まで、
              7つのレッスンで基礎を身につけましょう。
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {class0Lessons.map((lesson, i) => (
              ...
              >
                <Link
                  to={`/free-materials/class-0/${lesson.id}`}
