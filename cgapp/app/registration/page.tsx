  ...
  return (
    ...
    <div className = "">
      ...
      <section className = "bg-gradient-to-b from-neutral-700 via-gray-800 to-neutral-700">
        <RegisterCard courseNumber = "1" borderColor="border-cyan-100" picture={Expic} courseHeader="Course 1" price="FREE" durationStart="May 2022" durationEnd="October 2023" courseDescription={tempDescription}/>
        <RegisterCard courseNumber = "2" borderColor="border-cyan-200" picture={Expic} courseHeader="Course 2" price="FREE" durationStart="May 2022" durationEnd="October 2023" courseDescription={tempDescription}/>
        <div className = "relative z-10">
          <RegisterCard courseNumber = "3" borderColor="border-cyan-300" picture={Expic} courseHeader="Course 3" price="$100.00" durationStart="May 2022" durationEnd="October 2023" courseDescription={tempDescription}/>
        </div>
      </section>
      ...
      <section>
        ...
        <RegisterCard courseNumber = "4" borderColor="border-cyan-400" picture={Expic} courseHeader="Course 4" price="$120.00" durationStart="May 2022" durationEnd="October 2023" courseDescription={tempDescription}/>
        <RegisterCard courseNumber = "5" borderColor="border-cyan-500" picture={Expic} courseHeader="Course 5" price="$140.00" durationStart="May 2022" durationEnd="October 2023" courseDescription={tempDescription}/>
        <RegisterCard courseNumber = "6" borderColor="border-cyan-600" picture={Expic} courseHeader="Course 6" price="$160.00" durationStart="May 2022" durationEnd="October 2023" courseDescription={tempDescription}/>
